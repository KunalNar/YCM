        ...
        eLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(userName.isEmpty() || userPassword.isEmpty())
                {
                    ...
                    Toast.makeText(LoginAdmin.this, "Please enter name and password!", Toast.LENGTH_LONG).show();
                    ...
                    if (!isValid) {
                        ...
                        if (counter == 0) {
                            ...
                            Toast.makeText(LoginAdmin.this, "You have used all your attempts try again later!", Toast.LENGTH_LONG).show();
                        }
                        /* Display error message */
                        else {
                            Toast.makeText(LoginAdmin.this, "Incorrect credentials, please try again!", Toast.LENGTH_LONG).show();
                        }
                    }
                    /* If valid */
                    else {
                        ...
                        startActivity(new Intent(LoginAdmin.this, AdminMainActivty.class));
                    }
